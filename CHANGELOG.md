...
- `climatoology` version updated to 7.3.1
...
- update the underlying `climatoology` library to 7.2.0 enabeling planned plugins (and a display file bugfix)

## [2.6.0](https://gitlab.heigit.org/climate-action/api-gateway/-/releases/2.6.0) - 2026-06-03
...
- references to the (deprecated) websocket, which will be superceded by the solution
  to ([#30](https://gitlab.heigit.org/climate-action/api-gateway/-/work_items/30))
